...
const char * const status_str[] = {
  ...
  [STATUS_BAD_SEEK] = "STATUS_BAD_SEEK",
  
  [STATUS_NO_MANAGER] = "STATUS_NO_MANAGER",

  [STATUS_NO_FREE_FRAMES] = "STATUS_NO_FREE_FRAMES",
  [STATUS_UNPIN_ERR] = "STATUS_UNPIN_ERR",
  [STATUS_MARK_ERR] = "STATUS_MARK_ERR",
  [STATUS_FLUSH_ERR] = "STATUS_FLUSH_ERR",
